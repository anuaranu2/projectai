...
# Вычисление прироста населения в процентах за последние 5 лет (2019–2024)
data['Прирост (%) (2019-2024)'] = ((data[2024] - data[2019]) / data[2019]) * 100

# Сортировка данных по приросту
data_sorted = data.sort_values('Прирост (%) (2019-2024)', ascending=False)

# Выделение регионов с наибольшим приростом и спадом
leaders = data_sorted.head(5)
losers = data_sorted.tail(5)

# Визуализация прироста населения в процентах
plt.figure(figsize=(14, 8))
plt.bar(data_sorted['Регион'], data_sorted['Прирост (%) (2019-2024)'], color='steelblue')
plt.title('Прирост численности населения в процентах (2019-2024)', fontsize=16)
...
# Вывод регионов с наибольшим приростом и спадом в процентах
print("Регионы с наибольшим приростом населения в процентах за 2019–2024 годы:")
print(leaders[['Регион', 'Прирост (%) (2019-2024)']])

print("\nРегионы с наибольшим спадом населения в процентах за 2019–2024 годы:")
